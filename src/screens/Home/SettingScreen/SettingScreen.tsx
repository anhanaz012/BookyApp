...
import {FlatList, Switch, TouchableOpacity, View, Linking} from 'react-native';
...
import {DARK, LIGHT, settingList} from 'src/data/appData';
...
export default Wrapper(SettingScreen);
